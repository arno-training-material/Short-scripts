% simulate_model_dirac.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_model_dirac(tout,theta)
% [...] = simulate_model_dirac(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_dirac(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_dirac(varargin)
