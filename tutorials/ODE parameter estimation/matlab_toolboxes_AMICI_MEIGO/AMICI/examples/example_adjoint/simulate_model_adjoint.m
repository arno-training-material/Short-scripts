% simulate_model_adjoint.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_model_adjoint(tout,theta)
% [...] = simulate_model_adjoint(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_adjoint(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_adjoint(varargin)
