% simulate_model_dirac_adjoint.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_model_dirac_adjoint(tout,theta)
% [...] = simulate_model_dirac_adjoint(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_dirac_adjoint(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_dirac_adjoint(varargin)
...
sol = ami_model_dirac_adjoint(tout,theta(1:4),kappa(1:0),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
